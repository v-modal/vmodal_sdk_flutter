...
title: Flutter SDK v1.2.2 CCTV timestamp and metadata contract
summary:
  ...
  - Configured public pub.dev publishing to initialize GitHub Actions OIDC before upload, preventing interactive login during release automation.
