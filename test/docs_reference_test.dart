...
final requiredDocs = <String>[
  ...
  'vmodal_sdk_flutter/VModal-class.html',
  'vmodal_sdk_flutter/VModal/configure.html',
  'vmodal_sdk_flutter/VModalProject-class.html',
  'vmodal_sdk_flutter/VModalProject/scope.html',
  'vmodal_sdk_flutter/VModalProject/listCollections.html',
  'vmodal_sdk_flutter/VModalProject/close.html',
  'vmodal_sdk_flutter/VModalScope-class.html',
  'vmodal_sdk_flutter/VModalScope/upload.html',
  'vmodal_sdk_flutter/VModalScope/search.html',
...
void main() {
  ...
  test('search inventory exposes representative public SDK symbols', () {
    ...
    const expected = <String>[
      ...
      'vmodal_sdk_flutter.VModal',
      'vmodal_sdk_flutter.VModalProject',
      'vmodal_sdk_flutter.VModalScope',
      'vmodal_sdk_flutter.VModal.configure',
      'vmodal_sdk_flutter.VModalProject.scope',
      'vmodal_sdk_flutter.VModalProject.listCollections',
      'vmodal_sdk_flutter.VModalScope.upload',
      'vmodal_sdk_flutter.VModalScope.search',
