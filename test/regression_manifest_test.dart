...
void main() {
  ...
  test('required implementation and release artifacts exist', () {
    const files = <String>[
      ...
      'example/05_framebase_userlogin/README.md',
      'example/05_framebase_userlogin/lib/main.dart',
      'example/05_framebase_userlogin/lib/user/user_session_controller.dart',
  ...
  test(
    ...
    () async {
      ...
      for (final path in <String>[
        ...
        'example/04_example/test/widget_test.dart',
        'example/05_framebase_userlogin/README.md',
        'example/05_framebase_userlogin/MEDIA_SOURCES.md',
        'example/05_framebase_userlogin/readme_assets/library.png',
        'example/05_framebase_userlogin/readme_assets/search.png',
        'example/05_framebase_userlogin/readme_assets/playback.png',
        'example/05_framebase_userlogin/pubspec.lock',
        'example/05_framebase_userlogin/lib/main.dart',
        'example/05_framebase_userlogin/lib/user/auth_adapter.dart',
        'example/05_framebase_userlogin/lib/user/mock_firebase_auth.dart',
        'example/05_framebase_userlogin/lib/user/vmodal_credential.dart',
        'example/05_framebase_userlogin/lib/user/user_session_controller.dart',
